...
const Nav: React.FC = () => {
  ...
  return (
    <nav className="fixed top-3 left-1/2 transform -translate-x-1/2 mt-1 p-4 border border-gray-800 rounded-full bg-[#1a1a1a] bg-opacity-90 text-slate-50 shadow-bs z-10">
