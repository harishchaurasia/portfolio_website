  ...
  return (
    <nav className="fixed top-3 left-1/2 transform -translate-x-1/2 mt-1 p-4 border border-gray-800 rounded-full bg-[#1a1a1a] bg-opacity-85 text-slate-50 z-10">
      <ul className="flex items-center h-5 mx-0 space-x-8">
        ...
        <li className={`font-bruce text-xl py-2 px-4 rounded-full ${activeSection === 'about' ? 'bg-green-400 bg-opacity-70' : 'bg-opacity-0'} hover:bg-opacity-70`}>
          <Link to="about" smooth={true} duration={500} offset={-navbarHeight} className="cursor-pointer" onSetActive={() => handleSetActive('about')}>
            About
          </Link>
        </li>
        <li className={`font-bruce text-xl py-2 px-4 rounded-full ${activeSection === 'projects' ? 'bg-green-400 bg-opacity-70' : 'bg-opacity-0'} hover:bg-opacity-70`}>
        ...
        <li className={`font-bruce text-xl py-2 px-4 rounded-full ${activeSection === 'contact' ? 'bg-green-400 bg-opacity-70' : 'bg-opacity-0'} hover:bg-opacity-70`}>
