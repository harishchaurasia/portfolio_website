...
const About = () => {
  return (
    <div className="flex flex-col md:flex-row border border-gray-800 rounded-3xl shadow-bs p-2 md:mx-36 mt-10 md:mt-20 mx-16">
      <div className="flex flex-col items-center md:flex-row justify-center md:justify-start">
        <ImageWithRoundedCorners
          ...
          height="350px"
        />
        <div className="flex-1 mt-4 md:mt-0 md:ml-6 my-4 p-4 md:p-8 flex items-center justify-center md:justify-start">
          <p>
