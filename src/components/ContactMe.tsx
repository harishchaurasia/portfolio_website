          ...
          <div className="flex-1 text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4">
              <a
                ...
                className="bg-gray-200 hover:bg-gray-800 text-black hover:text-green-400 font-acorn py-3 px-8 rounded-full transition duration-10 text-sm md:text-lg lg:text-xl"
              >
                GitHub
              </a>
              <a
