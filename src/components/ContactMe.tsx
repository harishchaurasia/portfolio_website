...
const ContactMe: React.FC = () => {
  return (
    <div className=" py-4 mx-4 md:mx-16 lg:mx-44 my-56 md:my-20 space-y-10">
      <h1 className="text-[#30c555] text-6xl font-acorn font-bold text-left md:text-left mb-16">
        .Contact Me
      </h1>
      <div className="flex flex-col px-10 md:flex-row items-center justify-center">
        <div className='p-4 border border-gray-900 bg-black-800 bg-opacity-50 backdrop-blur-lg rounded-3xl'>
          <div className="flex-1 text-center">
            <p className="font-acornB text-white mt-4 mb-4 text-7xl font-bold">I'm Harish.</p>
            <p className="font-xirod my-4 text-[#999999] mt-8 mb-4 text-3xl">"I love building shit"</p>
